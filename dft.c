...
int parallelDFT(int idft, double *xr, double *xi, double *Xr_o, double *Xi_o, int N);
int main(int argc, char *argv[])
{
    ...
    // DFT
    int idft = 1;
    parallelDFT(idft, xr, xi, Xr_o, Xi_o, N);
    // IDFT
    idft = -1;
    parallelDFT(idft, Xr_o, Xi_o, xr_check, xi_check, N);
    // stop timer
